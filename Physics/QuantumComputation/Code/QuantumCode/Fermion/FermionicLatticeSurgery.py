...
from Physics.QuantumComputation.Helper.CycleComposition import GreedyCycleDecomposition
...
def FermionicLatticeSurgery(code_A, code_B, index_A, index_B)->FermionicCode:
    ...
    composition=GreedyCycleDecomposition(graph,number_ancilla-number_measurement_stabilizer+1)
    cycle_list = []
...
if __name__ == '__main__':
    ...
    code=FermionicLatticeSurgery(code_processor,code_memory,0,0)