...
from MokeQuantumComputation.Code.ClassicalCode.BicycleCode import BicycleCode
    ...
    for p in physical_p_list:
        ...
        for cycle in range(cycle_number):
            ...
            with Pool(processes=10) as pool:
                results = [pool.apply_async(simulation, args=(p_temp, sample_number,code,stabilizers)) for p_temp in [p]*10]
